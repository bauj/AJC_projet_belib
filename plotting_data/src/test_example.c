...
int main(int argc, char* argv[])
{
    ...
    int brect[8] = {0};
    char* f1 = "/usr/share/fonts/dejavu-sans-mono-fonts/DejaVuSansMono.ttf";
    char* f2 = "/usr/share/fonts/liberation-mono/LiberationMono-Regular.ttf";
    char* f3 = "/usr/share/fonts/abattis-cantarell-fonts/Cantarell-Regular.otf";
